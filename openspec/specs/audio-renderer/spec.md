...
### Requirement: Deterministic Stem Routing Compatibility
The renderer SHALL preserve deterministic routing behavior for declared stems while remaining compatible with legacy timelines that do not declare stem-routing metadata.
